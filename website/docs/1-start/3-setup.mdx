...
[Vacuum](https://github.com/daveshanley/vacuum) is a tool we use to ensure our APIs are well developed & documented. We install it this way:

```sh
brew install daveshanley/vacuum/vacuum
```

[aldev](#aldev) is responsible for using it automatically every time the API doc is modified.
